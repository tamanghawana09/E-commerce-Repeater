...
<div class="container">
    <form method="GET" action="<?php echo esc_url(home_url('/page-product')); ?>">
        <input type="text" name="name" placeholder="Product Name" value="<?php echo isset($_GET['name']) ? esc_attr($_GET['name']) : ''; ?>">
        ...
        <input type="number" name="price" placeholder="Max Price" value="<?php echo isset($_GET['price']) ? esc_attr($_GET['price']) : ''; ?>">
        <input type="number" name="rating" placeholder="Min Rating" value="<?php echo isset($_GET['rating']) ? esc_attr($_GET['rating']) : ''; ?>">
