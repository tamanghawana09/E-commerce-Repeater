...
<form action="" method="GET" class="filter-form">
    ...
    <input type="text" name="product_name" id="product_name" placeholder="Enter product name" value="<?php echo isset($_GET['product_name']) ? esc_attr($_GET['product_name']) : ''; ?>">
    ...
    <input type="number" name="price" id="price" placeholder="Enter price" value="<?php echo isset($_GET['price']) ? esc_attr($_GET['price']) : ''; ?>">

    <label for="rating">Rating:</label>
    <input type="number" name="rating" id="rating" placeholder="Enter rating (1-10)" value="<?php echo isset($_GET['rating']) ? esc_attr($_GET['rating']) : ''; ?>" min="1" max="10">
